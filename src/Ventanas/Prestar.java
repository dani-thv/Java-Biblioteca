...
public class Prestar extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("fecha en la que este será devuelto");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 110, 240, 30));

        jLabel1.setFont(new java.awt.Font("Segoe UI Black", 0, 14)); // NOI18N
        jLabel1.setText(" Usuario para realizar su préstamo, digite el libro y la");
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 80, 370, 30));

        prestar.setBackground(new java.awt.Color(204, 51, 255));
        prestar.setFont(new java.awt.Font("Lucida Sans", 1, 18)); // NOI18N
        ...
        getContentPane().add(prestar, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 410, 130, -1));
    ...
    private void prestarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_prestarActionPerformed
        String tituloLibro = titulolib.getText(); 
        String fechaDevolucion = fecha.getText(); //
        ...
        // Verificar si se encontró el libro y si está disponible para préstamo
        if (!libroEncontrado) {
            JOptionPane.showMessageDialog(this, "El libro no existe.", "Error", JOptionPane.ERROR_MESSAGE);
        } else if (Biblioteca.libroEstaPrestado(libroPrestamo)) {
            ...
            Prestamo prestamo = new Prestamo(libroPrestamo, obtenerFechaActual(), fechaDevolucion);
            Main.listaPrestamos.add(prestamo); 

            // Informar al usuario que el préstamo se realizó exitosamente
